...
if __name__ == "__main__":
    ...
    只用做展示如何自己实现策略，做回测用~
    相比于stragety_demo.py，本代码演示如何从CChan外部喂K线来触发内部缠论计算
    """
    code = "sz.000001"
    ...
    data_src = BaoStockFetcher(code, k_type=KL_TYPE.K_DAY, begin_date=begin_time, end_date=end_time, autype=AUTYPE.QFQ)  # 初始化数据源类
